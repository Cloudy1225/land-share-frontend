...
(0, _baseComponent.default)({
    ...
    computed: {
        classes: ["prefixCls, hoverClass, isLast, hasLine, isLink, disabled", function (e, t, n, a, i, r) {
            var s;
            return {
                wrap: (0, _classNames2.default)(e, (_defineProperty(s = {}, "".concat(e, "--last"), n), _defineProperty(s, "".concat(e, "--has-line"), a), _defineProperty(s, "".concat(e, "--access"), i), _defineProperty(s, "".concat(e, "--disabled"), r), s)),
                hd: "".concat(e, "__hd"),
    ...
    methods: {
        ...
        updateIsLastElement: function (e) {
            e !== this.data.isLast && this.setData({
                isLast: e
            })
        }
    }
